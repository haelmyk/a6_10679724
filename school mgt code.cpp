...
struct student
{
 string fname;//for student's first name
 string lname;//for student's last name
 string Registration;//for student's Registration number
 string classes;//for class information
}
...
struct teacher
{
 string fst_name;//Lecturer's firstname
 string lst_name;//Lecturer's last name
 string qualification;//Lecturer's qualification
 string exp;//Lecturer's years ofexperience
 string pay;//Lecturer's salary
 string subj;//course he/she is lecturing
 string lec;//Lecture per Week
 string addrs;//Lecturer's address
 string cel_no;//Phone number 
 string blod_grp;//Blood Group 
 string serves;//Number of years in the school
